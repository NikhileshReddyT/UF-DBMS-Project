 // This example requires the Visualization library. Include the libraries=visualization
      ...
      var sellersGeoLocation_lat = new Array();
      var sellersGeoLocation_lng = new Array();
      var sellersGeoLocation_count=new Array();
      var countSeller = 0;
      ...
      function getPointsForSeller()
      {
          var mapobject=new Array();
          var i = 0;
          for(i=0; i < countSeller; i++){
               
                var object = new google.maps.LatLng(sellersGeoLocation_lat[i], sellersGeoLocation_lng[i]);
                 mapobject.push({location:object,weight:1000});
